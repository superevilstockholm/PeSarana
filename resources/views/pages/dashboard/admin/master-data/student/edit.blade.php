...
@section('content')
    ...
    <div class="row">
        <div class="col">
            <div class="card my-0">
                <div class="card-body">
                    <form action="{{ route('dashboard.admin.master-data.students.update', $student->id) }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="form-floating mb-3">
                            <input type="text" name="nisn" class="form-control @error('nisn') is-invalid @enderror"
                                id="floatingInputNISN" placeholder="NISN" value="{{ old('nisn', $student->nisn) }}"
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                id="floatingInputName" placeholder="Nama Siswa" value="{{ old('name', $student->name) }}"
                                required>
                        ...
                        <div class="form-floating mb-3">
                            <input type="date" name="dob" class="form-control @error('dob') is-invalid @enderror"
                                id="floatingInputDOB" placeholder="Tanggal Lahir"
                        ...
                        <div class="form-floating mb-3">
                            <select name="classroom_id" id="floatingInputClassroom"
                                class="form-select @error('classroom_id') is-invalid @enderror" required>
