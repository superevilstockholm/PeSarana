        ...
        <div class="col mb-0">
            <div class="card">
                <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
                    <div>
                        <h3 class="fw-semibold mb-1 fs-3">Selamat datang, <span class="text-primary"></span>{{ $user->name }}! 👋</h3>
    ...
    <div class="row g-3">
        <div class="col-12 col-sm-6 col-md-3 mb-0">
            <div class="card border-0 mb-0 shadow-sm rounded-3 text-center py-4 position-relative overflow-hidden">
                ...
                <i class="ti ti-school fs-2 text-primary mb-2"></i>
                <h5 class="fw-bold mb-0">{{ $stats['students_count'] ?? 0 }}</h5>
                <small class="text-muted fs-09">Jumlah Siswa</small>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-3 mb-0">
            <div class="card border-0 mb-0 shadow-sm rounded-3 text-center py-4 position-relative overflow-hidden">
                ...
                <i class="ti ti-user fs-2 text-success mb-2"></i>
                <h5 class="fw-bold mb-0">{{ $stats['student_users_count'] ?? 0 }}</h5>
                <small class="text-muted fs-09">Jumlah User Siswa</small>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-3 mb-0">
            <div class="card border-0 mb-0 shadow-sm rounded-3 text-center py-4 position-relative overflow-hidden">
                ...
                <i class="ti ti-user-shield fs-2 text-danger mb-2"></i>
                <h5 class="fw-bold mb-0">{{ $stats['admin_users_count'] ?? 0 }}</h5>
                <small class="text-muted fs-09">Jumlah User Admin</small>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-3 mb-0">
            <div class="card border-0 mb-0 shadow-sm rounded-3 text-center py-4 position-relative overflow-hidden">
                ...
                <h5 class="fw-bold mb-0">{{ $stats['aspirations_count'] ?? 0 }}</h5>
        ...
        <div class="col-12 col-sm-6 col-md-3 mb-0">
            <div class="card border-0 mb-0 shadow-sm rounded-3 text-center py-4 position-relative overflow-hidden">
                ...
                <h5 class="fw-bold mb-0">{{ $stats['pending_aspirations_count'] ?? 0 }}</h5>
        ...
        <div class="col-12 col-sm-6 col-md-3 mb-0">
            <div class="card border-0 mb-0 shadow-sm rounded-3 text-center py-4 position-relative overflow-hidden">
                ...
                <h5 class="fw-bold mb-0">{{ $stats['on_going_aspirations_count'] ?? 0 }}</h5>
        ...
        <div class="col-12 col-sm-6 col-md-3 mb-0">
            <div class="card border-0 mb-0 shadow-sm rounded-3 text-center py-4 position-relative overflow-hidden">
                ...
                <h5 class="fw-bold mb-0">{{ $stats['completed_aspirations_count'] ?? 0 }}</h5>
        ...
        <div class="col-12 col-sm-6 col-md-3 mb-0">
            <div class="card border-0 mb-0 shadow-sm rounded-3 text-center py-4 position-relative overflow-hidden">
                ...
                <h5 class="fw-bold mb-0">{{ $stats['rejected_aspirations_count'] ?? 0 }}</h5>
