...
@section('title', 'Ubah Aspirasi - ' . config('app.name'))
@section('content')
    ...
    <div class="row">
        <div class="col">
            <div class="card my-0">
                <div class="card-body">
                    <form id="aspiration-form" action="{{ route('dashboard.student.aspirations.update', $aspiration) }}"
                        ...
                        <div class="mb-4">
                            ...
                            <div id="image-card-wrapper" class="d-flex flex-wrap gap-3">
                                @foreach ($aspiration->aspiration_images as $image)
                                    <div class="image-card border rounded position-relative d-flex flex-column justify-content-center align-items-center"
                                        style="width:150px;height:150px;" data-existing-id="{{ $image->id }}">
                                        <img src="{{ $image->image_path_url }}"
                                            class="w-100 h-100 object-fit-cover rounded">
                                        <button type="button"
                                            class="btn btn-sm btn-danger position-absolute top-0 end-0 m-1 d-none delete-btn"
                                ...
                                <div class="image-card border rounded position-relative d-flex flex-column justify-content-center align-items-center"
                                    ...
                                    <input type="file" name="aspiration_images[]" class="d-none"
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                                id="floatingInputTitle" placeholder="Judul Aspirasi"
                        ...
                        <div class="form-floating mb-3">
                            <textarea name="content" class="form-control @error('content') is-invalid @enderror" placeholder="Isi Aspirasi"
                                id="floatingTextareaContent" style="height: 120px">{{ old('content', $aspiration->content) }}</textarea>
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" name="location"
                                class="form-control @error('location') is-invalid @enderror" id="floatingInputLocation"
                                placeholder="Lokasi" value="{{ old('location', $aspiration->location) }}" required>
                        ...
                        <div class="form-floating mb-3">
                            <select name="category_id" id="floatingInputCategory"
    ...
    <script>
        ...
        function addEmptyCardIfNeeded() {
            ...
            if (!hasEmpty) {
                ...
                card.className =
                    'image-card border rounded position-relative d-flex flex-column justify-content-center align-items-center';
