            ...
            <div class="row g-4">
                ...
                <div class="col-12 col-lg-8 mx-auto">
                    <div class="accordion mt-4" id="faqAccordion">
                        <div class="accordion-item border-0 border-bottom bg-transparent rounded-0">
                            ...
                            <div id="faqOne" class="accordion-collapse collapse bg-transparent" data-bs-parent="#faqAccordion">
                        ...
                        <div class="accordion-item border-0 border-bottom bg-transparent rounded-0">
                            ...
                            <div id="faqTwo" class="accordion-collapse collapse bg-transparent" data-bs-parent="#faqAccordion">
                                <div class="accordion-body text-muted ff-open-sans">
                        ...
                        <div class="accordion-item border-0 border-bottom bg-transparent rounded-0">
                            ...
                            <div id="faqThree" class="accordion-collapse collapse bg-transparent" data-bs-parent="#faqAccordion">
                                <div class="accordion-body text-muted ff-open-sans">
                        ...
                        <div class="accordion-item border-0 border-bottom bg-transparent rounded-0">
                            ...
                            <div id="faqFour" class="accordion-collapse collapse bg-transparent" data-bs-parent="#faqAccordion">
                                <div class="accordion-body text-muted ff-open-sans">
